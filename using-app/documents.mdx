...
This article will guide you on how to export a Google Docs document to PDF.

### Steps

1. Open the Google Docs document you want to export.

2. Click on "Datei" (File) in the menu.

3. Select "Herunterladen" (Download).

4. Click on "PDF-Datei (.pdf)" to download the document as a PDF file.

5. Confirm the download by clicking "Sichern" (Save).